function Pop() {
  ...
  let createPopUp = function () {
    ...
    conDivObj.innerHTML = `
      <div class="freechat-popup ${
        content.show && "freechat-popup-show"
      }" id="freechat-popup">
        <div class="freechat-popup-header" style="background-color: ${
          ...
          <div class="freechat-popup-bottom">
            ${content.services
              .map(
                (item) => `<span class="fc-icon fc-icon-${item.name}${
      ...
      <div class="freechat-bottom">
        <p class="freechat-bottom-cta ${
          content.position === "left" && "freechat-bottom-cta-left"
        } ${
      content.position === "right" && "freechat-bottom-cta-right"
    }" id="freechat-bottom-cta">${content.button}</p>
    ...
    function serviceSeletor() {
      ...
      if (activeService === "whatsapp") {
        document.getElementById("freechat-popup-message").innerHTML =
          freechatInput;
        ...
        document.getElementById("freechat-popup-notinput-button").href =
          urlSelector;
      }
    }
    serviceSeletor();
